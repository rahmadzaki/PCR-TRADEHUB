...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="<?= base_url('assets/') ?>src/images/logos/favicon.png" />
  <link rel="stylesheet" href="<?= base_url('assets/') ?>src/css/styles.min.css" />
</head>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?= site_url('Home/') ?>" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?= site_url('Postingan/') ?>" aria-expanded="false">
                <span>
