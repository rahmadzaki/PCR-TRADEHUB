    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('Postingan/upload'); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="detail" class="form-control" id="detail" placeholder="Detail" required="">
                        </div>
                        <div class="form-group">
